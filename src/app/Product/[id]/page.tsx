...
const CarDetail = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 flex gap-8">
      {/* Sidebar Filters */}
      <aside className="w-1/4 bg-white p-6 rounded-lg shadow">
      ...
      <main className="w-3/4">
        {/* Hero Section */}
        <section className="bg-white text-white p-6 rounded-xl flex gap-3 items-center">
          <Image
          ...
          <div className="flex flex-col gap-2 w-1/2">
            ...
            <p className="text-gray-500 mt-2 text-center">The Toyota Corolla 2023 is a stylish and fuel-efficient sedan, perfect for city drives and long road trips. With a sleek design, spacious interior, and advanced safety features, this car offers a smooth and enjoyable ride for any occasion. </p>
